...
export default function CheckIn() {
  useEffect(() => {
    const SCRIPT_ID = "checkin-form-embed";
      ...
      <section className="pt-32 pb-12 bg-[#0D1B3E] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="text-[#00AEEF] text-xs font-bold uppercase tracking-widest">Post-Onboarding</span>
            <div className="h-px w-12 bg-[#00AEEF]" />
          </div>
          ...
          <p className="text-white/60 text-lg max-w-xl mx-auto">
            You've completed onboarding — let's review your progress, answer questions, and set you up for long-term success. Pick a time that works for you.
          </p>
        </div>
      </section>
          ...
          <div className="bg-[#0D1B3E] border border-[#00AEEF]/20 rounded-2xl overflow-hidden shadow-2xl shadow-[#00AEEF]/5">
            <div className="px-4 sm:px-6 py-4 border-b border-white/10">
              <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                ...
                <p className="text-[#00AEEF] text-xs font-bold uppercase tracking-widest">Post-Onboarding Check-In</p>
              </div>
            </div>
            <div className="p-2">
              <iframe
                src="https://link.bookmore.app/widget/booking/tO4Gk9pU8j4bEPmb3DEf"
                style={{ width: "100%", border: "none", overflow: "hidden", minHeight: "680px" }}
                scrolling="no"
                id="tO4Gk9pU8j4bEPmb3DEf_1782777134827"
                title="Post-Onboarding Check-In Call"
              />
            </div>
          </div>
        </div>
