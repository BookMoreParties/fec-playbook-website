...
export default function KeithLauraCal() {
  useEffect(() => {
    const SCRIPT_ID = "keithlauracal-form-embed";
          ...
          <div className="bg-[#0D1B3E] border border-[#00AEEF]/20 rounded-2xl overflow-hidden shadow-2xl shadow-[#00AEEF]/5">
            <div className="px-6 py-5 border-b border-white/10">
              <div className="flex items-center gap-3">
                ...
                <p className="text-[#00AEEF] text-xs font-bold uppercase tracking-widest">Keith & Laura's Calendar</p>
              </div>
            </div>
            <div className="p-2">
              <iframe
