/**
 * FEC Playbook — Calendar Thank You Page
 * Route: /cal-thankyou
 * Generic post-booking confirmation. No navigation. Same design as ThankYou.tsx.
 * Unlisted: blocked in robots.txt and excluded from sitemap.
 */

import { useEffect, useState } from "react";
import { Link } from "wouter";
import { CheckCircle, Calendar, Clock, Mail, ArrowRight, Play, Star, Users, Zap, Phone } from "lucide-react";
...
const nextSteps = [
  ...
  },
  {
    ...
    description: "Get a head start before your call. Our short overview walks you through exactly how FEC Playbook is structured so your time is spent on your specific questions.",
    color: "#1565C0",
  },
  {
    step: "03",
    ...
    description: "What's costing you the most time or revenue right now? Birthday party follow-ups? Hiring? Reputation management? We'll make the most of your time together.",
    color: "#00AEEF",
  },
];
    ...
    <div className="min-h-screen bg-[#0A0A0A]">
      ...
      <section className="relative pt-20 pb-20 overflow-hidden">
        ...
        <div
          ...
          style={{ backgroundImage: `radial-gradient(circle at 50% 40%, #00AEEF 0%, transparent 55%)` }}
        />
        {/* Circuit grid */}
        <div
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {/* Label */}
          <div
            className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full border mb-6"
          ...
          >
            You're On the{" "}
            <span style={{ color: "#00AEEF" }}>Calendar.</span>
          </h1>

          <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed mb-8">
            Your call is booked. Our team is looking forward to connecting with you. Check your email for the calendar invite.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
            ...
            <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl px-5 py-3">
              ...
              <span className="text-white/70 text-sm font-medium">Add it to your calendar so you don't miss it</span>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {testimonialSnippets.map((t) => (
              <div key={t.initials} className="rounded-2xl border border-white/10 bg-white/3 p-7">
      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              { href: "/features", label: "See All Features", desc: "13+ core modules explained", icon: Zap, color: "#00AEEF" },
              { href: "/playbook", label: "View the Playbook", desc: "8 systems, 100+ automations", icon: Users, color: "#1565C0" },
              { href: "/how-it-works", label: "How It Works", desc: "The 3-step onboarding process", icon: Play, color: "#00AEEF" },
            ].map((card) => {
