...
export default function TC2() {
  useEffect(() => {
    const SCRIPT_ID = "tc2-form-embed";
      ...
      <section className="pt-32 pb-12 bg-[#0D1B3E] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="text-[#00AEEF] text-xs font-bold uppercase tracking-widest">Training Call 2 of 4</span>
            <div className="h-px w-12 bg-[#00AEEF]" />
          </div>
          ...
          <p className="text-white/60 text-lg max-w-xl mx-auto">
            Activate your sales pipeline and start converting leads. Pick a time that works for you.
          </p>
        </div>
      </section>
          ...
          <div className="bg-[#0D1B3E] border border-[#00AEEF]/20 rounded-2xl overflow-hidden shadow-2xl shadow-[#00AEEF]/5">
            <div className="px-6 py-5 border-b border-white/10">
              <div className="flex items-center gap-3">
                ...
                <p className="text-[#00AEEF] text-xs font-bold uppercase tracking-widest">TC2 — Sales Activation</p>
              </div>
            </div>
            <div className="p-2">
              <iframe
                ...
                scrolling="no"
                id="daAZWf9lM7UsvUL7XDXo_1782776867585"
                title="Training Call 2 — Sales Activation"
              />
            </div>
          </div>
        </div>
