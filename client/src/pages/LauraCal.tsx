/*
 * FEC Playbook — Laura's Calendar Page
...
export default function LauraCal() {
  useEffect(() => {
    const SCRIPT_ID = "lauracal-form-embed";
          ...
          <div className="bg-[#0D1B3E] border border-[#00AEEF]/20 rounded-2xl shadow-2xl shadow-[#00AEEF]/5">
            <div className="px-4 sm:px-6 py-4 border-b border-white/10">
              <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                ...
                <p className="text-[#00AEEF] text-xs font-bold uppercase tracking-widest">Laura's Calendar</p>
              </div>
            </div>
            <div className="p-2">
              <iframe
                src="https://link.bookmore.app/widget/booking/Ndpiusu5eOOqmloAwXZt"
                style={{ width: "100%", border: "none", display: "block", minHeight: "900px" }}
                scrolling="no"
                id="R3u6Bhxlbvor0mR3jjei_1782224086305"
                title="Book Time with Laura"
              />
            </div>
          </div>
        </div>
