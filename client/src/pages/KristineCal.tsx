...
export default function KristineCal() {
  useEffect(() => {
    const SCRIPT_ID = "kristinecal-form-embed";
          ...
          <div className="bg-[#0D1B3E] border border-[#00AEEF]/20 rounded-2xl overflow-hidden shadow-2xl shadow-[#00AEEF]/5">
            <div className="px-4 sm:px-6 py-4 border-b border-white/10">
              <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                ...
                <p className="text-[#00AEEF] text-xs font-bold uppercase tracking-widest">Kristine's Calendar</p>
              </div>
            </div>
            <div className="p-2">
              <iframe
                src="https://link.bookmore.app/widget/booking/BGpiuDbii2r3Nw3PDIKX"
                style={{ width: "100%", border: "none", overflow: "hidden", minHeight: "680px" }}
                scrolling="no"
                id="BGpiuDbii2r3Nw3PDIKX_1782224107581"
                title="Book Time with Kristine"
              />
            </div>
          </div>
        </div>
